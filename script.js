...
function girar() {
  ...
  const tempoLimite = 3600000; // 1 hora
  ...
  reels.forEach((reel, i) => {
    ...
    reel.style.animation = `spin 1.2s ease-in-out ${i * 0.2}s`;
    setTimeout(() => {
  ...
  setTimeout(() => {
    ...
    if (todasIguais) {
      ...
      resultadoEl.textContent = `Tentativa ${dadosRoleta.tentativas}/3. Você ganhou! A emoção de tentar novamente.`;
